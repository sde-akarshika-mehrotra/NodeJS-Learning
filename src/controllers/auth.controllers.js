...
import {
  emailVerificcationMailgenContent,
...
const registerUser = asyncHandler(async (req, res) => {
  ...
  await sendEmail({
    ...
    mailgenContent: emailVerificcationMailgenContent(
      user.username,
  ...
  return res
    ...
    .json(
      new ApiResponse(
        200,
        { user: createdUser },
        "User registered successsfully and verificationemail has been sent on your email",
      ),
    );
});
...
const resetForgotPassword = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, {}, "Password reset successfullly"));
});
